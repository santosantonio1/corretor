...
int main() {
    ...
    while(prog_aluno = readdir(aluno)) {
        ...
        rename(guarda_nome_prog, "Aluno\\prog.cpp");
        system("g++ -o testaInputCpp Aluno\\prog.cpp");
        rename("Aluno\\prog.cpp", guarda_nome_prog);
    ...
    while(dp) {
            ...
            system("testaInputCpp < input\\input > output.txt");
